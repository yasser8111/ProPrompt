  ...
  const categories = [
    {
      ...
      icon: ImageIcon,
      color: "bg-indigo-soft/50 text-indigo-primary border-indigo-primary/10",
      count: "120+",
    },
    {
      title: t("categories.writing"),
      icon: FileText,
      color: "bg-amber-soft/50 text-amber-primary border-amber-primary/10",
      count: "80+",
    },
    {
      title: t("categories.coding"),
      icon: Code,
      color:
        "bg-emerald-soft/50 text-emerald-primary border-emerald-primary/10",
      count: "50+",
    },
    {
      title: t("categories.productivity"),
      icon: Zap,
      color: "bg-rose-soft/50 text-rose-primary border-rose-primary/10",
      count: "40+",
    },
  ];
    ...
    <div className="pb-20">
              ...
              >
                <div className="relative z-10 text-center md:text-start">
                  ...
                  <p className="font-bold text-gray-400 uppercase tracking-widest text-[10px]">
                    {cat.count} {t("categories.promptsCount")}
                  </p>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-40 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-20 space-y-4 md:space-y-0 text-center md:text-start">
            <div>
              <h2 className="text-4xl font-black text-gray-900 mb-3 tracking-tighter uppercase">
                {t("trending.title")}
              </h2>
              <p className="text-gray-500 text-lg font-medium">
                {t("trending.subtitle")}
            ...
            <Link
              to="/prompts"
              className="flex items-center text-blue-600 font-bold uppercase tracking-widest text-xs hover:text-blue-700 transition-colors"
            >
              {t("trending.viewAll")}
      ...
      <section className="bg-gray-900 py-40 rounded-[80px] mx-4 sm:mx-10 px-6 overflow-hidden relative">
        <div className="max-w-7xl mx-auto text-center md:text-start relative z-10">
          <h2 className="text-4xl font-black text-white mb-24 tracking-tighter uppercase">
            {t("howItWorks.title")}
          </h2>
            ...
            {[
              {
                ...
                text: t("howItWorks.step1.desc"),
              },
              {
                step: "02",
                title: t("howItWorks.step2.title"),
                text: t("howItWorks.step2.desc"),
              },
              {
                step: "03",
                title: t("howItWorks.step3.title"),
                text: t("howItWorks.step3.desc"),
              },
            ].map((item, i) => (
